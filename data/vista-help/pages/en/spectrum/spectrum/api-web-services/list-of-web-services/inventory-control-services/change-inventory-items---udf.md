---
title: "Change Inventory Items - UDF | Trimble Help"
source_url: "https://help.trimble.com/en/spectrum/spectrum/api-web-services/list-of-web-services/inventory-control-services/change-inventory-items---udf"
fetched_at: "2026-04-03T18:19:14.179823+00:00"
menu_path: "/en/spectrum/spectrum/api-web-services/list-of-web-services/inventory-control-services/change-inventory-items---udf"
---

# Change Inventory Items - UDF

Use this service to update existing inventory item's information for the user-defined fields only.
WSDL: UpdateInv_UDF.jws
Method: UpdateInv_UDF
...
- The Inventory Items-UDF Web Service updates existing inventory item's information for the defined fields only.

- Any field that is left blank will not be updated in Spectrum. The service does not delete values that exist in Spectrum; it only changes data defined in the layout.

- The Inventory Items user-defined fields need to be defined in Spectrum.
...
Text
10
Item Code must exist for the defined Company Code.
