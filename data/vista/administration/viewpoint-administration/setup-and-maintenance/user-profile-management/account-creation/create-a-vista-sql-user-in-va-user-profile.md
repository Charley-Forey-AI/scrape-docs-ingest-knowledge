...
source_url: "https://help.trimble.com/en/vista/vista/administration/viewpoint-administration/setup-and-maintenance/user-profile-management/account-creation/create-a-vista-sql-user-in-va-user-profile"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/administration/viewpoint-administration/setup-and-maintenance/user-profile-management/account-creation/create-a-vista-sql-user-in-va-user-profile"
---
...
In order to complete this process, you must have access
 ...
 that point, you should [Create a Vista User SSO Account with Trimble ID](/en/vista/vista/administration/viewpoint-administration/setup-and-maintenance/user-profile-management/account-creation/create-a-vista-user-sso-account-with-trimble-id) when setting up new Vista users. Legacy cloud and
...
1. Use the Form & Report Options section to set the user's general settings.Note: This form and the User Options form (Options > User
 ...
 [User Options](/en/vista/vista/system-tools/user-interface-guide/about-the-main-menu/main-menu-options/about-the-user-options-form) F1 help
