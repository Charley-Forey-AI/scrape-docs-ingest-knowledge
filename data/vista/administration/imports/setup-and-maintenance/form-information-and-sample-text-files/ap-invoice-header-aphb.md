---
title: "AP Invoice Header (APHB) | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/administration/imports/setup-and-maintenance/form-information-and-sample-text-files/ap-invoice-header-aphb"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/administration/imports/setup-and-maintenance/form-information-and-sample-text-files/ap-invoice-header-aphb"
---
...
####
no
Viewpoint CM Account for paying this transaction.
NOTE:If you check the Use Viewpoint Default box for
 the template (in IM Template), this value defaults from the CM Account field
 in AP Vendors. If that field is blank, the value defaults from the CM
 Account # field in AP Coimpany Parameters (Subledgers tab)
...
###
no
Specify the Vista Box # that will be used to
 accumulate and print 1099 amounts. Refer to the F4 lookup on the Box
...
1 Character
no
"Y" to override the name and/or address specified
 for this vendor in the AP Vendors.
