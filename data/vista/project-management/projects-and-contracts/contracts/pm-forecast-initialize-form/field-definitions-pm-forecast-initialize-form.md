---
title: "Field Definitions: PM Forecast Initialize Form | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/project-management/projects-and-contracts/contracts/pm-forecast-initialize-form/field-definitions-pm-forecast-initialize-form"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/project-management/projects-and-contracts/contracts/pm-forecast-initialize-form/field-definitions-pm-forecast-initialize-form"
---

# Field Definitions: PM Forecast Initialize Form
...
Check this box to re-initialize contract forecasts. During initialization, if a forecasts already exists for a contract, it will be re-initialized using current forecast options and the contract's current original and estimate amounts.
...
Check the box for each contract status to include in forecast initialization.

- Pending - Check to include contracts with a status of 0-Pending. (These will be contracts set up PM Contracts that have not been interfaced to Job Cost.)

- Open - Check to include contracts with a status of 1-Open. (These will be contracts set up in Job Cost or set up in PM and interfaced to Job Cost.)
...
Enter the number of months past the current month to forecast for contract's with no projected completion date. Forecast periods generated during initialization will be extended this number of months past the current month.
...
This field is enabled only when Initialize By option is 'Project Manager'.
Enter the project manager (from JC Project
 ...
 project manager (via the project in PM Projects) and having a status matching one of the
 statuses selected above, will be included in the forecast initialization.
