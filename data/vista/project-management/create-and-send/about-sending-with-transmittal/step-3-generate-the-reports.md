---
title: "Step 3: Generate the report(s) | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/project-management/create-and-send/about-sending-with-transmittal/step-3-generate-the-reports"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/project-management/create-and-send/about-sending-with-transmittal/step-3-generate-the-reports"
---

# Step 3: Generate the report(s)
...
The reports that are associated with a form display
 ...
 Reportsin the toolbar at the top of a form. This means if you want to generate
 an RFI report, you need to add an RFI record to the Documents tab and the PM Request
 For Information form must be associated with the report that you want to
 generate.
...
1. Select the report that you
 want to generate int he Documentcolumn.

You cannot generate an SSRS report
Currently SSRS reports are not compatible with the
 Create and Send feature. SSRS reports will not display in theForm Report
  drop down, even if they are associated with a form.
...
1. Go to the next step, adding attachments. [More](/en/vista/vista/project-management/create-and-send/about-sending-with-transmittal/step-4---optional-add-the-attachments)
