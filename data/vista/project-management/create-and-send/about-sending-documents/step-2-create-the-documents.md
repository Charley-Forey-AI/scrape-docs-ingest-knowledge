---
title: "Step 2: Create the document(s) | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/project-management/create-and-send/about-sending-documents/step-2-create-the-documents"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/project-management/create-and-send/about-sending-documents/step-2-create-the-documents"
---

# Step 2: Create the document(s)

Follow the steps below to generate a project document using the [Create and Send](/en/vista/vista/project-management/create-and-send/about-the-create-and-send-feature) feature.
The steps below will generate a PDF document using a document template, which means you cannot edit the generated document. Click [here](/en/vista/vista/project-management/create-and-send/about-generating--editing-project-documents) if you need to edit the document before it is sent.

1. Open the Documents tab on
 the PM Send Documents form.

1. Each generated document
 displays as an item on the tab.

1. Select Template
 in the Document Source column.

1. Select a template in the
...
- Template is not active - Only active document templates will
 ...
 Info tab of the [PM Create & Send Templates Form](/en/vista/vista/project-management/create-and-send/pm-create--send-templates-form)form.
...
1. Optional:
 ...
 box and
 Edit Documents
 button to edit the generated projects documents before they are sent. [More](/en/vista/vista/project-management/document-tracking/pm-document-edit-manager-form)

1. If you set up a default document template on the company or project, the
 Document
 column will default with that selection. Click [here](/en/vista/vista/project-management/create-and-send/assign-a-project-template) for more information.

1. Optional: Generate additional documents to include in the email. Use the PM Search Documents form to select
...
1. The Project field is disabled and will display the currently
 selected project.
...
Note:These fields will populate with default values based
...
- Use the Category field to find
 ...
 category, launch the Create and Send () feature from the [PM Subcontracts](/en/vista/vista/project-management/subcontracts/pm-subcontracts-form) form.
...
1. The documents will be generated and added as
 attachments when the email is sent.

1. Go to the next step, generating reports. [More](/en/vista/vista/project-management/create-and-send/about-sending-documents/step-3---optional-generate-reports)
