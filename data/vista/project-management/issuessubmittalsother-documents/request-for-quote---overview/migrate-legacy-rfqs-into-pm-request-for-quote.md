---
title: "Migrate Legacy RFQs into PM Request For Quote | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/project-management/issuessubmittalsother-documents/request-for-quote---overview/migrate-legacy-rfqs-into-pm-request-for-quote"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/project-management/issuessubmittalsother-documents/request-for-quote---overview/migrate-legacy-rfqs-into-pm-request-for-quote"
---

# Migrate Legacy RFQs into PM Request For Quote

You can use the PM Migrate Data form to migrate legacy RFQs into the PM Request For Quote form.
...
1. Assign the duplicate RFQs a new number using one of the following methods:

1. Manually - Use the RFQ column to manually assign a new RFQ number to each duplicate RFQ. For example assign a duplicate RFQ a new RFQ number and then press TAB. The duplicate RFQ will be removed from the list in the lower portion of the form.

1. Automatically - Select the Generate next available record # for all duplicates box if you would like the system to automatically assign the duplicate RFQs the next available number when they are migrated to the new form.

1. Click Migrate.

1. Click Yes on the message that displays.
