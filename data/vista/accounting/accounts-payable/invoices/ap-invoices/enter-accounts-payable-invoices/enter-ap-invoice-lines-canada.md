---
title: "Enter AP Invoice Lines: Canada | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/accounting/accounts-payable/invoices/ap-invoices/enter-accounts-payable-invoices/enter-ap-invoice-lines-canada"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/accounting/accounts-payable/invoices/ap-invoices/enter-accounts-payable-invoices/enter-ap-invoice-lines-canada"
---

# Enter AP Invoice Lines: Canada

Once you've created the header portion of an invoice, enter the detail line items. This article applies if you're working in an AP Company whose HQ Country is Canada.
...
1. If you want to include the Misc Amt in the line's total, select the Included checkbox. However, the system does not include the miscellaneous amount when calculating taxes, discounts, or holdback for the line.

1. For invoices entered in AP Transaction Entry only: if the invoice for this subcontractor/vendor is subject to on-cost, select the Subject to On-Cost checkbox.

1. Enter any holdback or discount amounts in the Hbk %, Hbk Amt, Disc %, and Disc Amt fields.
