---
title: "Record Deletion | Trimble Help"
source_url: "https://help.trimble.com/en/vista/vista/system-tools/user-interface-guide/system-forms/record-deletion"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/system-tools/user-interface-guide/system-forms/record-deletion"
---
...
Warning: If you have pulled a transaction into a batch that has already been processed (posted in another batch), the delete functions described above will only delete the transaction (or line) from the current batch. If you want to delete the transaction (or line) from the system files, you must change the Action field in the Header (or Lines section) to D (Delete), then post the batch as usual.
