...
source_url: "https://help.trimble.com/en/vista/vista/system-tools/user-interface-guide/system-forms/about-the-field-properties-form/field-definitions-field-properties-form"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/system-tools/user-interface-guide/system-forms/about-the-field-properties-form/field-definitions-field-properties-form"
---
...
Note: Data will be masked on the Info tab only. Data in the same field on the Grid tab will not be masked. To hide the data in the Grid, [hide the grid column](/en/vista/vista/system-tools/user-interface-guide/system-forms/form-grids). In this case, users can enter the data in the Info tab.
...
For information about time stamped notes, see [About Timestamping Notes](/en/vista/vista/system-tools/user-interface-guide/about-timestamping-notes).
