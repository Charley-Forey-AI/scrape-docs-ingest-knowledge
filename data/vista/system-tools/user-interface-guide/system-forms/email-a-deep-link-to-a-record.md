...
source_url: "https://help.trimble.com/en/vista/vista/system-tools/user-interface-guide/system-forms/email-a-deep-link-to-a-record"
fetched_at: "2026-03-25T16:24:33.094126+00:00"
menu_path: "/en/vista/vista/system-tools/user-interface-guide/system-forms/email-a-deep-link-to-a-record"
---

# Email a Deep Link to a Record

You can send an email that contains a deep link to a specific record in a maintenance form using the Email Link to Record option in the Tools menu of the form. Deep links can be emailed from any maintenance form that is available from the Folders pane on the [Menu tab](/en/vista/vista/system-tools/user-interface-guide) of the Main Menu. With maintenance forms that have header and detail panes, deep links can be emailed for header records.
