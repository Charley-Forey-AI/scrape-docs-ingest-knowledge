...
source_url: "https://help.trimble.com/en/spectrum/spectrum/project-management/job-cost/spectrum-menus/data-entry-overview/procedures-overview/reclassifying-an-invoice-recorded-to-the-wrong-job-with-a-correction-in-accounts-payable"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/project-management/job-cost/spectrum-menus/data-entry-overview/procedures-overview/reclassifying-an-invoice-recorded-to-the-wrong-job-with-a-correction-in-accounts-payable"
---

# Reclassifying an Invoice Recorded to the Wrong Job with a Correction in Accounts Payable

These steps may be used to reclassify an invoice recorded to the wrong job that will also show the correction in Accounts Payable

- On the Site Map screen, click Accounts Payable  >  Invoice Entry  >  > Reverse.

- Create a credit memo for the incorrect invoice.

- To create a credit memo, on the Site Map screen, click Accounts Payable  >  Data Entry  >  Invoice/Credit Memo.

- More information on creating credit memos can be found in the Accounts Payable Help file. Re-enter the invoice, classifying it to the correct job.
