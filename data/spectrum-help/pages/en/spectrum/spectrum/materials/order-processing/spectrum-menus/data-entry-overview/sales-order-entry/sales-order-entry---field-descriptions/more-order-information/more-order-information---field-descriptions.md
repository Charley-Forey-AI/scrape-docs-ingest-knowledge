---
title: "More Order Information - Field Descriptions | Trimble Help"
source_url: "https://help.trimble.com/en/spectrum/spectrum/materials/order-processing/spectrum-menus/data-entry-overview/sales-order-entry/sales-order-entry---field-descriptions/more-order-information/more-order-information---field-descriptions"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/materials/order-processing/spectrum-menus/data-entry-overview/sales-order-entry/sales-order-entry---field-descriptions/more-order-information/more-order-information---field-descriptions"
---

# More Order Information - Field Descriptions
...
Remark
Any comments entered in this field will appear on the printed order. Double-click to select from a list of available messages.
...
Quoted hauler
Enter the hauler code that was used on this order, if any, or select from a list of available hauler codes.
...
Enter the name of the company or person to whom this order is to be delivered, along with the mailing address.

Weight
If Inventory Control is installed, the total weight of all items displays. No entry is allowed. If Inventory Control is not installed, this field remains blank.
