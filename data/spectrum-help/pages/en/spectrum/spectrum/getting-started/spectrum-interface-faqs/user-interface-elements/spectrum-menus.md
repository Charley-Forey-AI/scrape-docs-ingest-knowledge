...
source_url: "https://help.trimble.com/en/spectrum/spectrum/getting-started/spectrum-interface-faqs/user-interface-elements/spectrum-menus"
fetched_at: "2026-04-03T20:47:47.926179+00:00"
menu_path: "/en/spectrum/spectrum/getting-started/spectrum-interface-faqs/user-interface-elements/spectrum-menus"
---

# Spectrum menus

When you initially log on to Spectrum, the Site Map screen will display. This is the "main screen" in Spectrum.
Along the left side of the screen, the module menu displays. The modules that your company has installed and that you have security access to display on the menu. After selecting a module, the processing menu will be enabled. Processing menu items include the following options:
