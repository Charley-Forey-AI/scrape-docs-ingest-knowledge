---
title: "Transfer Change Orders to Draw Request - Cost Center Information | Trimble Help"
source_url: "https://help.trimble.com/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/data-entry-overview/draw-request-entry/transfer-change-orders-to-draw-request/transfer-change-orders-to-draw-request---cost-center-information"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/data-entry-overview/draw-request-entry/transfer-change-orders-to-draw-request/transfer-change-orders-to-draw-request---cost-center-information"
---

# Transfer Change Orders to Draw Request - Cost Center Information

If the cost center feature is enabled in the Enterprise Installation screen, when transferring change orders to draw request Spectrum will display change requests and change orders for the job if the operator has access to the contract cost center. As the operator requests each job, Spectrum compares the cost center assigned to the job with cost centers in the operator's assigned scheme; if the cost center is not included, then changes for that job will not be shown.
