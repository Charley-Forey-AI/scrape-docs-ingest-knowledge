---
title: "Customer Sales Report - Field Descriptions | Trimble Help"
source_url: "https://help.trimble.com/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/reports-overview/customer-sales-report/customer-sales-report---field-descriptions"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/reports-overview/customer-sales-report/customer-sales-report---field-descriptions"
---

# Customer Sales Report - Field Descriptions
...
Selections
Enter the Customer #, Customer type and Salesperson code you want included on the report, or press Enter to include ALL.

Through date
Enter the invoice date through which this report should print, or press Enter to print through the current Accounts Receivable processing date. The current fiscal year and processing period display to the right of this field.

Sort by
Select the sort option that corresponds to how you want the report information sorted.
...
Sample Report - Customer Sales Report
