---
title: "Change Order Log Report - Field Descriptions | Trimble Help"
source_url: "https://help.trimble.com/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/maintenance-overview/contracts/contract-reports/change-order-log-report/change-order-log-report---field-descriptions"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/accounting/accounts-receivable/spectrum-menus/maintenance-overview/contracts/contract-reports/change-order-log-report/change-order-log-report---field-descriptions"
---

# Change Order Log Report - Field Descriptions
...
Selections
Enter the job number, customer code and change order, or press Enter to include ALL on the report.
Select whether to include change order notes and change request details on the report.

Issued dates
Specify the starting and ending change order issue dates to include on the report.

Approved dates
Specify the starting and ending change order approval dates to include on the report.

Job status
Select a job status to print:
