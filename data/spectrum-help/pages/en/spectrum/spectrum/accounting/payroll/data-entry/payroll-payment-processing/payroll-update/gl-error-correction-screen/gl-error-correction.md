...
source_url: "https://help.trimble.com/en/spectrum/spectrum/accounting/payroll/data-entry/payroll-payment-processing/payroll-update/gl-error-correction-screen/gl-error-correction"
fetched_at: "2026-04-03T20:05:26.860879+00:00"
menu_path: "/en/spectrum/spectrum/accounting/payroll/data-entry/payroll-payment-processing/payroll-update/gl-error-correction-screen/gl-error-correction"
---
...
G/L Error Correction - Make Error Corrections
Errors shown on the G/L Error Correction screen must be corrected before completing the update. Corrections can be
 made on this screen, or you may cancel out of the screen to make changes elsewhere in
 Spectrum. The chart below shows the different error types along with suggestions on how
 to clear them.
Error Message
Indicates
...
Note: Enhanced security is provided for the G/L Error
 Correction screen. If the user initiating the update does not have
 level 8 security authorization, a warning message displays. It is recommended that
 the user review the updated report; searching for the word, ERROR helps identify the
 records in question. The user will then need to contact the supervisor for
 assistance.G/L Error Correction - Field Descriptions
...
- [G/L Error Correction Change Log](/en/spectrum/spectrum/accounting/payroll/data-entry/payroll-payment-processing/payroll-update/gl-error-correction-screen/gl-error-correction-change-log)
